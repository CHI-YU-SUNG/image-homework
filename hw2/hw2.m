...
top_25_freq=zeros(25,1);
top_25_freq_position=zeros(25,2);
[top_25_freq,top_25_freq_position]=maxk(abs(fftOriginal(:)),25);
location=find(abs(fftOriginal(:))>=top_25_freq(25));
